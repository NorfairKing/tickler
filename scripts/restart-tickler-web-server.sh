...
export TICKLER_SERVER_VERIFICATION_EMAIL_ADDRESS=verification@tickler.cs-syd.eu
export TICKLER_SERVER_TRIGGERED_EMAIL_ADDRESS=triggered@tickler.cs-syd.eu
